...
exports.CreateType2Service = void 0;
const prisma_1 = __importDefault(require("../../prisma"));
const util = __importStar(require("../../util"));
class CreateType2Service {
    execute({ id_type1, name }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const type2AlreadyExists = yield prisma_1.default.type2.findFirst({
                where: {
                    name: name
                }
            });
            ...
            const type2 = yield prisma_1.default.type2.create({
                data: {
                    id_type1: id_type1,
                    name: name
                }
...
exports.CreateType2Service = CreateType2Service;
