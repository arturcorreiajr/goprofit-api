...
exports.CreateType1Service = void 0;
...
class CreateType1Service {
    execute({ name }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const type1AlreadyExists = yield prisma_1.default.type1.findFirst({
                where: {
                    name: name
                }
            });
            ...
            const type1 = yield prisma_1.default.type1.create({
                data: {
                    name: name
                },
                select: {
...
exports.CreateType1Service = CreateType1Service;
